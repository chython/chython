...
class MoleculeContainer(MoleculeStereo, Graph[Element, Bond], Morgan, Rings, MoleculeIsomorphism,
    ...
    def iupac(self) -> Optional[str]:
        """
        IUPAC name generated by openclatura (structure->name).

        Returns None when openclatura cannot name the structure.
        Requires the optional `openclatura` dependency (Python >= 3.11).
        """
        try:
        ...
        return name_rdkit_mol(self.to_rdkit()) or None
