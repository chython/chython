...
from .kamada_kawai import KamadaKawai
...
class Calculate2DMolecule(KamadaKawai):
    ...
    def clean2d(self: Union['MoleculeContainer', 'Calculate2DMolecule'],
        ...
        if bonds:
            bond_reduce = sum(bonds) / len(bonds) / BL
        else:
            bond_reduce = 1.
    ...
    def _clean2d(self: Union['MoleculeContainer', 'Calculate2DMolecule'], *,
        ...
        for component in self.connected_components:
            if len(component) == 2:  # 2-atom mols always stored horizontally
                ...
                self._apply_kamada_kawai(component)
