...
class LinearFingerprint:
    ...
    def linear_fingerprint(self, min_radius: int = 1, max_radius: int = 4,
                           ...
                           number_bit_pairs: int = 4) -> ndarray:
        """
    ...
    def linear_hash_smiles(self, min_radius: int = 1, max_radius: int = 4,
    ...
    def _chains(self, min_radius: int = 1, max_radius: int = 4) -> set[tuple[int, ...]]:
    ...
    def _fragments(self, min_radius: int = 1, max_radius: int = 4) -> dict[tuple[int, ...], list[tuple[int, ...]]]:
