...
_transformations = [
    ('isoxazole_from_diketone', 'isoxazole', 'O=C(C)CC(=O)C>>c1(onc(C)c1)C', 1,
     {'alpha_halogenation', 'oximation'}),
    ('pyridazine_from_diketone', 'pyridazine', 'O=C(C)CCC(=O)C>>c1(C)nnc(C)cc1', 1,
     {'alpha_halogenation', 'oximation'}),
    ('appel_primary_alcohol', 'appel', 'OCC>>BrCC', 1, {'triflation', 'appel_chloride', 'mesylation', 'tosylation'}),
    ('appel_secondary_alcohol', 'appel', 'OC(C)CC>>BrC(C)CC', 1, {'triflation', 'appel_chloride', 'mesylation', 'tosylation'}),
