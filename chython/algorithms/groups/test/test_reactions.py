...
_two_component = [
    ...
    ('weinreb_amidation_acid_diethylhydroxylamine',
     'weinreb_amidation', 'OC(=O)c1ccccc1.CCON(CC)>>c1ccccc1C(=O)N(CC)OCC', 1),
    ...
    ('mitsunobu_azinone_alcohol',
     'mitsunobu', 'OCCCC.O=c1[nH]cnc2ccccc12>>c1cccc2c1ncnc2OCCCC', 1),
    ...
    ('decarboxylative_coupling_nhpi_ester_aryl_bromide',
     ...
     'CCC(=O)ON1C(=O)c2ccccc2C1=O.Brc1ccc(cc1)C>>c1cc(ccc1C)CC', 1),
    ('deaminative_coupling_alkyl_amine_aryl_bromide',
     'deaminative_coupling', 'NCCC.Brc1ccc(cc1)C>>c1cc(ccc1C)CCC', 1, {'buchwald_hartwig'}),
    ('deaminative_coupling_alkyl_amine_aryl_chloride',
     'deaminative_coupling', 'NCCC.Clc1ccc(cc1)C>>c1cc(ccc1C)CCC', 1, {'buchwald_hartwig'}),
    ('deaminative_coupling_alkyl_amine_aryl_iodide',
     'deaminative_coupling', 'NCCC.Ic1ccc(cc1)C>>c1cc(ccc1C)CCC', 1, {'buchwald_hartwig'}),
    ('deaminative_coupling_aniline_diazonium_aryl_bromide',
     'deaminative_coupling', 'Nc1ccccc1.Brc1ccc(cc1)C>>c1ccccc1-c1ccc(C)cc1', 1, {'buchwald_hartwig'}),
    ('deaminative_coupling_aniline_diazonium_aryl_iodide',
     'deaminative_coupling', 'Nc1ccccc1.Ic1ccc(cc1)C>>c1ccccc1-c1ccc(C)cc1', 1, {'buchwald_hartwig'}),
    ...
    ('thioetherification_aryl_iodide_thiophenol',
     'thioetherification', 'Ic1ccccc1.Sc1ccccc1>>c1ccc(Sc2ccccc2)cc1', 1),
    ('thioetherification_aryl_bromide_alkyl_thiol',
     'thioetherification', 'Brc1ccc(C)cc1.SCC>>CCSc1ccc(C)cc1', 1),
    ('thioetherification_aryl_chloride_thiophenol',
     'thioetherification', 'Clc1ccccc1.Sc1ccccc1>>c1ccc(Sc2ccccc2)cc1', 1),
    ...
    ('van_leusen_pyrrole_isocyanoacetate_propiolate',
     'van_leusen_pyrrole', 'CCOC(=O)C[N+]#[C-].C#CC(OCC)=O>>c1[nH]c(cc1C(=O)OCC)C(OCC)=O', 1),
...
_transformations = [
    ...
    ('borylation_aryl_bromide', 'borylation_acid', 'Brc1c(C)c(C)c(C)c(C)c1C>>OB(O)c1c(C)c(C)c(C)c(C)c1C', 1,
     {'borylation_ester', 'cyanation', 'halide_hydrolysis', 'azidation', 'finkelstein', 'halex',
      'halide_to_chloride', 'halide_to_methoxy', 'halide_to_thioether', 'halide_to_thiol'}),
    ('borylation_alkenyl_bromide', 'borylation_ester',
     'BrC1=CCCCC1>>CC1(C)OB(OC1(C)C)C1=CCCCC1', 1, {'borylation_acid'}),
    ('nitrile_hydrolysis', 'nitrile_hydrolysis', 'N#CCC>>NC(=O)CC', 1, {'nitrile_to_acid'}),
    ('hydrazide_from_ester', 'ester_to_hydrazide', 'CCOC(=O)c1ccccc1>>NNC(=O)c1ccccc1', 1,
     {'ester_hydrolysis', 'ester_to_amide', 'ester_to_hydroxamic_acid',
    ...
    ('bromination_benzene', 'bromination', 'c1ccccc1>>Brc1ccccc1', 1,
     {'nitration', 'chlorination', 'iodination', 'fluorination'}),
    ...
    ('azinone_chlorination_pyridone', 'azinone_chlorination',
     'O=c1cccc[nH]1>>Clc1ccccn1', 1,
     {'amide_hydrolysis', 'oxo_to_thioxo'}),
    ('azinone_chlorination_quinazolinone', 'azinone_chlorination',
     'O=c1[nH]cnc2ccccc12>>Clc1ncnc2ccccc12', 1,
     {'amide_hydrolysis', 'oxo_to_thioxo',
      'bromination', 'chlorination', 'fluorination', 'iodination', 'nitration'}),
    ('azinone_hydrolysis_chloroquinazoline', 'azinone_hydrolysis',
     'Clc1ncnc2ccccc12>>O=c1[nH]cnc2ccccc12', 1,
     {'amide_hydrolysis', 'oxo_to_thioxo',
      'bromination', 'chlorination', 'fluorination', 'iodination', 'nitration',
      'borylation_acid', 'borylation_ester', 'cyanation', 'azidation', 'finkelstein', 'halex',
      'halide_hydrolysis', 'halide_to_bromide', 'halide_to_chloride', 'halide_to_methoxy',
      'halide_to_thioether', 'halide_to_thiol'}),
]
