...
class MoleculeStereo:
    ...
    @cached_property
    def cumulenes(self) -> list[tuple[int, ...]]:
        """
    ...
    @cached_property
    def stereogenic_tetrahedrons(self) -> dict[int, tuple[int, int, int] | tuple[int, int, int, int]]:
        """
    ...
    @cached_property
    def stereogenic_cumulenes(self) -> dict[tuple[int, ...], tuple[int, int, int | None, int | None]]:
        """
    ...
    @cached_property
    def stereogenic_allenes(self) -> dict[int, tuple[int, int, int | None, int | None]]:
        """
    ...
    @cached_property
    def stereogenic_cis_trans(self) -> dict[tuple[int, int], tuple[int, int, int | None, int | None]]:
        """
    ...
    @cached_property
    def ring_tetrahedrons(self) -> dict[int, tuple[int, int] | tuple[int] | tuple]:
        """
    ...
    @cached_property
    def rings_linker_tetrahedrons(self) -> dict[int, tuple[int, int, int, int]]:
        """
    ...
    @cached_property
    def ring_cumulenes_terminals(self) -> set[tuple[int, int]]:
        """
    ...
    @cached_property
    def rings_linker_cumulenes_terminals(self) -> dict[tuple[int, int], tuple[int, int, int, int]]:
        """
    ...
    @cached_property
    def ring_attached_cumulenes(self) -> dict[tuple[int, int], tuple[int, int] | tuple[int]]:
        """
    ...
    def add_wedge(self, n: int, m: int, mark: int, *, clean_cache=True):
        """
    ...
    def _translate_tetrahedron_sign(self, n, env, s=None):
        """
    ...
    def _translate_cis_trans_sign(self, n, m, nn, nm, s=None):
        """
    ...
    def _translate_allene_sign(self, c, nn, nm, s=None):
        """
        get sign for specified opposite neighbors
    ...
    def __differentiation(self, morgan, atoms_stereo, cis_trans_stereo, allenes_stereo):
